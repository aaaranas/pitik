...
export const FILTER_PRESETS: FilterDefinition[] = [
  ...
  },
  {
    ...
    adjustments: {
      ...
      vignette: 0.22,
      grain: 0.18,
      splitHighlight: { color: "#ffe9c9", amount: 0.36 },
      splitShadow: { color: "#2a3a46", amount: 0.32 },
    },
  },
  {
    id: "flash",
...
export const CAMERA_PROFILES: CameraProfile[] = [
  {
    ...
    adjustments: {},
    // No categories: Everyday is the whole shelf.
    timestamp: false,
    flashLook: false,
  },
  {
    ...
    // The section *is* the models. Selecting Digicam offers the cameras, not
    // the full filter shelf.
    filterCategories: ["Digicam"],
    timestamp: true,
    flashLook: false,
  },
  {
  ...
  },
  {
    ...
    filterCategories: ["Digicam", "Night"],
    timestamp: true,
    flashLook: true,
  },
  {
